...
export const TRADEBOT_DEFAULT_CRYPTO_WATCHLIST = [
  'BTC-CAD',
  'ETH-CAD',
  'SOL-CAD',
  'DOGE-CAD',
...
export const TRADEBOT_DEFAULT_CRYPTO_WATCHLIST_CSV = TRADEBOT_DEFAULT_CRYPTO_WATCHLIST.join(',')

export function parseWatchlist(
  raw: string | undefined,
  fallback: readonly string[] = TRADEBOT_DEFAULT_WATCHLIST
): string[] {
  const fromEnv = (raw || '')
    .split(',')
