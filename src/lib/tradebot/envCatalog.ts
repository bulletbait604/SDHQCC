...
export const TRADEBOT_ENV_CATALOG: TradebotEnvItem[] = [
  ...
  },
  {
    ...
    label: 'Kraken public',
    keys: [],
    purpose: 'CAD crypto reference prices. No key for quotes; keys only if we execute later.',
  },
  {
    id: 'quotes',
    group: 'already',
    ...
    keys: [],
    purpose: 'TSX .TO prints with no API key. This is the default quote path.',
  },
  {
    id: 'paper-flag',
    group: 'required',
  ...
  },
  {
    ...
    purpose: 'Defaults: 5% daily CAD drawdown halt, 15% max per name, CA$100 paper NAV.',
  },
  {
    id: 'ibkr',
    group: 'optional',
