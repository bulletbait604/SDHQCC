...
export const homeTranslations = {
  en: {
    ...
    tradeBot: 'TradeBot',
    tradeBotDesc:
      'Kraken CAD coins only. Start with CA$100. One swing ticket (~75% of the book): dip in an uptrend, maker limits, take ~8–12% so fees do not eat the win. Halt the day at -8%. Fake to practice, Real for Kraken. Switching to Real turns the desk OFF — press ON to trade.',
